...
<body>
											...
											<tbody>
												<c:forEach items="${listWatch }" var="item">
													<tr>
														...
														<td>${item.watchImage}</td>
														<td>${item.watchCategoryId}</td>
														<td><a href="#editEmployeeModal" class="edit"
															data-toggle="modal"
															onclick="setEdit(${item.watchId},'${item.watchName }',${item.watchPrice },${item.quantity },'${item.watchDescription }','${item.watchImage }',${item.watchCategoryId })"><i
																class="material-icons" data-toggle="tooltip"
																title="Edit">&#xE254;</i></a> 
																<a href="#deleteEmployeeModal"
															class="delete" data-toggle="modal"
															onclick="setId(${item.watchId})"><i
																class="material-icons" data-toggle="tooltip"
																title="Delete">&#xE872;</i></a></td>
													</tr>
    ...
    <div class="form-group">
        <label>Watch ID</label> <input type="text" id="watchId" name="id" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Name</label> <input type="text" id="watchName" name="name" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Price</label> <input type="number" id="watchPrice" name="price" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Quantity</label> <input type="number" id="watchQuantity" name="quantity" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Description</label> <input type="text" id="watchDescription" name="description" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Image</label> <input type="text" id="watchImage" name="image" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Category ID</label> <input type="text" id="watchCategoryId" name="categoryid" class="form-control" required>
    </div>
										...
										<form action="UpdateWatchServlet" method="post">
											...
											<div class="modal-body">
												...
												<div class="form-group">
													...
													<input type="number" id="watchPrice"
														name="price" value="" class="form-control" required>
												</div>
												<div class="form-group">
													<label>Quantity</label> <input type="number"
														id="watchQuantity" name="quantity" value=""
														class="form-control" required>
												</div>
												<div class="form-group">
													<label>Description</label> <input type="text"
														id="watchDescription" name="description" value=""
														class="form-control" required>
												</div>
												<div class="form-group">
													<label>Image</label> <input type="text" id="watchImage"
														name="image" value="" class="form-control" required>
												</div>
												<div class="form-group">
...
function setEdit(id, name, price, quantity,description, image, categoryId) {
    ...
    document.getElementById('watchQuantity').value = quantity;
    document.getElementById('watchDescription').value = description;
    document.getElementById('watchImage').value = image;
	...
	color: #555;
				...
				<div class="error-container">
					...
					<a class="nav-link px-2"
								href="LogoutServlet"> <i class="fas fa-sign-out-alt mr-1"></i><span>Back Login</span>
							</a>
				</div>
				<%
				}
