...
<body data-bs-spy="scroll" data-bs-target="#navbar"
	...
	<div class="search-popup">
		<div class="search-popup-container">
			...
			<form role="search" method="get" class="search-form" action="SearchServlet">
	...
	<section id="latest-blog" class="padding-large">
		<div class="container">
			<div class="row">
				...
				<div style="display:inline-block;  class="page">
					<% 
					...
					%>
					<%= WatchDAO.getSearchPaginationBar("SearchServlet", WatchDAO.gettotalByKey(key), cpage, 3,2,key) %>
